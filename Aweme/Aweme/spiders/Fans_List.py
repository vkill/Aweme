...
class AwemeInfoSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.max_time = query.get_fans_max_time()
    ...
    def start_requests(self):
        for user_id in self.User_ID_List:
            ...
            yield scrapy.Request(url=start_url, callback=self.parse,dont_filter=True, meta={'url': start_url})
        ...
        try:
            ...
            if int(maxtime) > self.max_time:
                for fan_list in fans_lists:
                    ...
                    yield item
                if has_more:
                    # 下一页url中的"max_time"为上一次json数据中的"min_time"i
                    ...
                    print('next_start_url:', next_start_url)
